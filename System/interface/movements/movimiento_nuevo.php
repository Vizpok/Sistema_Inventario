<?php
/**
 * Movimientos - Formulario Nueva Transferencia
 * Formulario para crear una nueva transferencia entre ubicaciones
 */
...
<div class="page-container">
    <div class="page-header">
        ...
        <p class="page-subtitle">Registra un movimiento de producto entre ubicaciones</p>
    </div>
    ...
    <form method="POST" action="<?= $base_url ?>/System/interface/movements/movimiento_procesar.php" id="formTransferencia">
        ...
        <div class="form-container">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="form-help">Producto a transferir</div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            placeholder="0"
                        >
                        <div class="form-help">Cantidad a transferir</div>
            ...
            <!-- Ubicaciones -->
            <div class="form-section">
                <h3 class="form-section-title">Ubicaciones</h3>

                <div class="form-row">
                    <div class="form-group">
                        <label for="id_ubicacion_origen">Ubicación Origen <span class="required">*</span></label>
                        <select id="id_ubicacion_origen" name="id_ubicacion_origen" required disabled>
                            <option value="">-- Selecciona producto y lote --</option>
                        </select>
                        <div class="form-help">Ubicación de donde se transfiere</div>
                        <div class="error-message">Debes seleccionar una ubicación de origen</div>
                    </div>

                    <div class="form-group">
                        <label for="id_ubicacion_destino">Ubicación Destino <span class="required">*</span></label>
                        <select id="id_ubicacion_destino" name="id_ubicacion_destino" required>
                            <option value="">-- Selecciona una ubicación --</option>
                            <?php foreach ($ubicaciones as $ub): ?>
                            <option value="<?= $ub['ID_UBICACION'] ?>"><?= $ub['CODIGO_UBICACION'] ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="form-help">Ubicación de destino</div>
                        <div class="error-message">Debes seleccionar una ubicación de destino</div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-circle"></i> Registrar Transferencia
                </button>
    ...
    <script>
        ...
        document.getElementById('formTransferencia').addEventListener('submit', function(e) {
            ...
            if (!idUbicacionDestino) {
                document.getElementById('id_ubicacion_destino').parentElement.classList.add('error');
                isValid = false;
            }

            if (idUbicacionOrigen && idUbicacionDestino && idUbicacionOrigen === idUbicacionDestino) {
                document.getElementById('id_ubicacion_destino').parentElement.classList.add('error');
                document.querySelector('[for="id_ubicacion_destino"]').nextElementSibling.nextElementSibling.textContent = 'Las ubicaciones no pueden ser iguales';
                isValid = false;
            }
