<?php
/**
 * Catálogo de Proveedores - Listado
 * Vista de todos los proveedores del sistema
 */
...
if ($search) {
    ...
    $where = " WHERE NOMBRE LIKE '%$search_escaped%' OR RFC LIKE '%$search_escaped%' OR CONTACTO LIKE '%$search_escaped%'";
}

// Obtener total de proveedores
$count_query = db()->select("SELECT COUNT(*) as total FROM proveedores $where");
...
<div class="page-container">
    <div class="page-header">
        ...
        <p class="page-subtitle">Gestiona los proveedores de productos para tu negocio</p>
    </div>
    ...
    <div class="page-header">
        <div class="page-header-content">
            <h2 style="margin: 0; font-size: 20px; color: #0b1e36;">Total de proveedores: <strong><?= number_format($total) ?></strong></h2>
        </div>
        <a href="proveedores_nuevo.php" class="btn-primary">
    ...
    <div class="search-section">
        <form style="display: flex; gap: 12px; width: 100%;" method="GET">
            ...
            <?php if ($search): ?>
            <a href="proveedores.php" class="btn-reset"><i class="bi bi-x-circle"></i> Limpiar</a>
            <?php endif; ?>
        </form>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="proveedores_eliminar.php?id=<?= $proveedor['ID_PROVEEDOR'] ?>" class="btn-action btn-delete" onclick="return confirm('¿Estás seguro de que deseas eliminar este proveedor?');">
    ...
    <div class="table-container">
        <div class="empty-state">
            ...
            <p><?= $search ? 'Intenta con otro criterio de búsqueda.' : 'Crea el primer proveedor para comenzar.' ?></p>
            <a href="proveedores_nuevo.php" class="btn-primary" style="margin-top: 20px;">
