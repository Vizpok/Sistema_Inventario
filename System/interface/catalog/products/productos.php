 ...
 * Vista de todos los productos del sistema
 */
...
<div class="page-container">
    <div class="page-header">
        ...
        <p class="page-subtitle">Gestiona el listado de productos disponibles en el sistema</p>
    </div>
    ...
    <div class="page-header">
        <div class="page-header-content">
            <h2 style="margin: 0; font-size: 20px; color: #0b1e36;">Total de productos: <strong><?= number_format($total) ?></strong></h2>
        </div>
        <a href="productos_nuevo.php" class="btn-primary">
    ...
    <div class="search-section">
        <form style="display: flex; gap: 12px; width: 100%;" method="GET">
            ...
            <?php if ($search): ?>
            <a href="productos.php" class="btn-reset"><i class="bi bi-x-circle"></i> Limpiar</a>
            <?php endif; ?>
        </form>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="productos_eliminar.php?id=<?= $producto['ID_PRODUCTO'] ?>" class="btn-action btn-delete" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">
    ...
    <div class="table-container">
        <div class="empty-state">
            ...
            <p><?= $search ? 'Intenta con otro criterio de búsqueda.' : 'Crea el primer producto para comenzar.' ?></p>
            <a href="productos_nuevo.php" class="btn-primary" style="margin-top: 20px;">
