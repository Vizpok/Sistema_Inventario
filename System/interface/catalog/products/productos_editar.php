<?php
/**
 * Catálogo de Productos - Formulario Editar
...
<div class="page-container">
    ...
    <form method="POST" action="productos_actualizar.php" id="formProducto">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            class="readonly"
                        >
                        <div class="form-help">El SKU no puede modificarse una vez creado</div>
                    </div>
